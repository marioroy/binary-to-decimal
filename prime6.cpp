/*  prime6.cpp - print number of decimal digits in biggest known prime number
    ...
    Compiled under OS X with g++ 4.2
        ...
        g++ -O3 -fopenmp prime6.cpp -I/usr/local/include
            -L/usr/local/lib -lgmp -o prime6 -Wno-attributes

        # using pthreads for parallel recursion in mpn_get_str
        g++ -O3 -pthread prime6.cpp -I/usr/local/include
            -L/usr/local/lib -lgmp -o prime6 -Wno-attributes

    Compiled under Windows with VC++ 2010
        cl /nologo /EHs /O2 /I C:\mpir-2.6.0\lib\Win32\Release prime6.cpp
            /Feprime6.exe /link C:\mpir-2.6.0\lib\Win32\Release\mpir.lib
